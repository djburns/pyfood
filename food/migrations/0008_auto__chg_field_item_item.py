...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Item.item'
        db.alter_column(u'food_item', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['food.Item']))

    def backwards(self, orm):

        # Changing field 'Item.item'
        db.alter_column(u'food_item', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2014, 5, 10, 0, 0), to=orm['food.Item']))
    ...
    models = {
        ...
        u'food.item': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': u"orm['food.Item']"}),
