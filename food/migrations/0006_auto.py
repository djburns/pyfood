...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing M2M table for field vendor on 'Event'
        db.delete_table(db.shorten_name(u'food_event_vendor'))

        # Adding M2M table for field vendors on 'Event'
        m2m_table_name = db.shorten_name(u'food_event_vendors')
    ...
    def backwards(self, orm):
        # Adding M2M table for field vendor on 'Event'
        m2m_table_name = db.shorten_name(u'food_event_vendor')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm[u'food.event'], null=False)),
            ('vendor', models.ForeignKey(orm[u'food.vendor'], null=False))
        ...
        db.delete_table(db.shorten_name(u'food_event_vendors'))
