...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Order'
        db.create_table(u'food_order', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['food.Event'])),
            ('vendor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['food.Vendor'])),
            ('organiser', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('closing_date', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal(u'food', ['Order'])

        # Adding model 'Event'
        db.create_table(u'food_event', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('postcode', self.gf('django.db.models.fields.CharField')(max_length=8)),
        ))
        db.send_create_signal(u'food', ['Event'])

        # Adding model 'Vendor'
        db.create_table(u'food_vendor', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal(u'food', ['Vendor'])


    def backwards(self, orm):
        # Deleting model 'Order'
        db.delete_table(u'food_order')

        # Deleting model 'Event'
        db.delete_table(u'food_event')

        # Deleting model 'Vendor'
        db.delete_table(u'food_vendor')
