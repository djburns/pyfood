...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'food_event', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


        # Changing field 'Item.price'
        db.alter_column(u'food_item', 'price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2))

    def backwards(self, orm):
        # Deleting field 'Event.description'
        db.delete_column(u'food_event', 'description')


        # Changing field 'Item.price'
        db.alter_column(u'food_item', 'price', self.gf('django.db.models.fields.DecimalField')(default=datetime.datetime(2014, 5, 10, 0, 0), max_digits=4, decimal_places=2))
    ...
    models = {
        ...
        u'food.event': {
            ...
            'vendors': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['food.Vendor']", 'symmetrical': 'False'})
        },
        u'food.item': {
            'Meta': {'object_name': 'Item'},
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'blank': 'True', 'to': u"orm['food.Item']"}),
